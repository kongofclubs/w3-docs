...
const tokens = [
  {
    ...
    href: 'https://www.dextools.io/app/en/ether/pair-explorer/0xb3d241dc705bdd43ac68725e11782ae1ac5a12b8',
    icon: IconOne,
  },
  {
    name: 'Contract',
      ...
      <Popover className="relative">
        {({ open }) => (
          <>
            ...
            >
              <Popover.Panel className="absolute left-1/2 z-10 mt-3 w-80 max-w-sm -translate-x-1/2 transform px-4 sm:px-0 lg:max-w-3xl">
